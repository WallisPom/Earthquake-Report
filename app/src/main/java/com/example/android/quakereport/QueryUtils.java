...
public final class QueryUtils {
    ...
    //final indicates value an never change
     ...
     */
    //private indicates no one should create an instance of this class
    private QueryUtils() {
    }
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for( int i = 0; i < earthquakeArray.length(); i++ ){
               ...
               // String magnitude = properties.getString("mag"); old version
                String location = properties.getString("place");
               // String time = properties.getString("time"); old version
